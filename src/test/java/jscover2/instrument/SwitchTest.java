...
public class SwitchTest {
    ...
    public void shouldCoverSwitchDefaultPath() throws ScriptException {
        ...
        assertThat(engine.eval("jscover['test.js'].s['3']"), equalTo(1));
        assertThat(engine.eval("jscover['test.js'].s['4']"), equalTo(1));
        assertThat(engine.eval("JSON.stringify(jscover['test.js'].sD)"), equalTo("{\"1\":{\"pos\":{\"line\":1,\"col\":0,\"len\":10}},\"2\":{\"pos\":{\"line\":2,\"col\":10,\"len\":10}},\"3\":{\"pos\":{\"line\":3,\"col\":11,\"len\":12}},\"4\":{\"pos\":{\"line\":4,\"col\":2,\"len\":2}}}"));
